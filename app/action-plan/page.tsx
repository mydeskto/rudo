    ...
    <div className="min-h-screen bg-[#F1F1F1] font-sans">
      ...
      <section className="relative min-h-[20vh] bg-[#DAF9A0] text-[#101703] pt-26 pb-10 px-6 overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center gap-8">
          ...
          >
            <FileText className="w-5 h-5 text-[#101703]" />
            <span className="px-4 py-2 rounded-full border border-[#101703]/10 text-sm text-[#101703]/60 bg-[#101703]/5 backdrop-blur-sm">
              Action Plan
            </span>
          </motion.div> */}
          ...
          >
            ...
            <span className="text-[#101703]">development roadmap</span>
          </motion.h1>
                ...
                >
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    <div className="flex shrink-0">
                      <div className="w-16 h-16 rounded-full bg-[#DAF9A0] flex items-center justify-center">
                        <span className="text-2xl font-bold text-[#101703]">{item.step}</span>
                      </div>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-4">
                        <IconComponent className="w-6 h-6 text-[#101703]" />
                        <h3 className="text-2xl md:text-3xl font-bold text-[#101703]">
                          {item.title}
                        </h3>
                      </div>
