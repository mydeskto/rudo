    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="relative min-h-[40vh] bg-foreground text-white pt-32 pb-10 px-6 overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center gap-4">
          ...
          >
            We create custom WordPress websites with beautiful designs and powerful functionality. Fast, secure, and easy to manage.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p className="text-lg">
              We specialize in creating custom WordPress websites that combine beautiful design with powerful functionality. Our WordPress services include custom theme development, plugin creation, and WooCommerce integration.
            </p>
            <p>
              We build WordPress sites that are fast, secure, SEO-friendly, and easy to manage. From custom themes to plugin development, we deliver professional WordPress solutions tailored to your business needs.
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: "Unique WordPress themes designed specifically for your brand. Responsive, modern, and optimized for performance."
            },
            {
              icon: FileCode,
              title: "Plugin Development",
              desc: "Custom WordPress plugins to extend functionality and meet your unique business requirements."
            },
            {
              icon: ShoppingCart,
              title: "WooCommerce Integration",
              desc: "Full e-commerce solutions with WooCommerce. Product management, payment gateways, and shopping cart functionality."
            },
            {
              icon: Zap,
              title: "WordPress Optimization",
              desc: "Speed optimization, caching, and performance tuning to ensure your WordPress site loads quickly and efficiently."
            },
            {
              icon: Shield,
              title: "Security & Updates",
              desc: "WordPress security hardening, regular updates, and backup solutions to keep your site safe and secure."
            },
            {
              icon: Settings,
              title: "Easy Content Management",
              desc: "User-friendly admin interfaces and training to help you manage your content easily and efficiently."
            }
          ].map((item, i) => {
        ...
        <div className="bg-foreground rounded-[3rem] p-12 md:p-16 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Let's discuss your WordPress project and create a custom solution that meets your business needs.
          </p>
