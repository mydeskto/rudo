...
import { Shield, RefreshCw, Bug, Zap, HeadphonesIcon, FileCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="relative min-h-[40vh] bg-foreground text-white pt-32 pb-10 px-6 overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center gap-4">
          ...
          >
            Keep your website <br className="hidden md:block" />
            <span className="text-primary-soft">running smoothly</span>
          </motion.h1>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              Our support plans are designed to keep your website secure, up-to-date, and performing optimally, allowing you to focus on your business while we handle the technical aspects.
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: "Keep your website up-to-date with the latest security patches, feature updates, and platform improvements."
            },
            {
              icon: Shield,
              title: "Security Monitoring",
              desc: "Continuous security monitoring, malware scanning, and protection against vulnerabilities and threats."
            },
            {
              icon: Bug,
              title: "Bug Fixes",
              desc: "Quick resolution of bugs and issues to ensure your website functions correctly and provides a smooth user experience."
            },
            {
              icon: Zap,
              title: "Performance Optimization",
              desc: "Ongoing performance monitoring and optimization to ensure your website loads quickly and efficiently."
            },
            {
              icon: FileCheck,
              title: "Backup & Recovery",
              desc: "Regular backups and disaster recovery plans to protect your data and ensure quick recovery if needed."
            },
            {
              icon: HeadphonesIcon,
              title: "Technical Support",
              desc: "Dedicated technical support to help you with any questions, issues, or feature requests whenever you need assistance."
            }
          ].map((item, i) => {
        ...
        <div className="bg-foreground rounded-[3rem] p-12 md:p-16 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Let's discuss your maintenance and support needs and create a plan to keep your website running smoothly.
          </p>
