...
import { Globe, Search, TrendingUp, MapPin, FileText, BarChart } from "lucide-react";
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="relative min-h-[40vh] bg-foreground text-white pt-32 pb-10 px-6 overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center gap-4">
          ...
          >
            Improve your search <br className="hidden md:block" />
            <span className="text-primary-soft">engine rankings</span>
          </motion.h1>
          ...
          >
            Comprehensive SEO services including On-Page, Off-Page, Technical, and Local SEO to improve your website's visibility and drive organic traffic.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p className="text-lg">
              We provide comprehensive SEO services to improve your website's search engine visibility and rankings. Our SEO approach includes On-Page SEO, Off-Page SEO, Technical SEO, and Local SEO.
            </p>
            <p>
          ...
          {[
            {
              icon: FileText,
              title: "On-Page SEO",
              desc: "Content optimization, meta tags, headings, and internal linking for relevant keywords to improve search rankings."
            },
            {
              icon: Globe,
              title: "Off-Page SEO",
              desc: "Building high-quality backlinks and managing online reputation to boost domain authority and search visibility."
            },
            {
              icon: TrendingUp,
              title: "Technical SEO",
              desc: "Improving site speed, mobile-friendliness, structured data, and crawlability for better search engine indexing."
            },
            {
              icon: MapPin,
              title: "Local SEO",
              desc: "Optimizing for local search results, including Google Business Profile management and local citations."
            },
            {
              icon: Search,
              title: "Keyword Research",
              desc: "Thorough keyword research to identify high-impact search terms that drive targeted traffic to your website."
            },
            {
              icon: BarChart,
              title: "Analytics & Reporting",
              desc: "Continuous monitoring and analytics to track performance, measure results, and refine SEO strategies."
            }
          ].map((item, i) => {
        ...
        <div className="bg-foreground rounded-[3rem] p-12 md:p-16 text-center">
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            Let's discuss your SEO needs and create a strategy to improve your search rankings and drive organic traffic.
          </p>
